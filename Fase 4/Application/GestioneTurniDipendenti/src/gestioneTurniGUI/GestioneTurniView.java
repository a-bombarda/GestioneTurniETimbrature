...
import gestioneTurniApplication.ApriGestioneFabbisognoActionListener;
...
public class GestioneTurniView {
	...
	private final JMenuItem mntmGestisciFabbisogno = new JMenuItem("Gestisci Fabbisogno");
	...
	private void initialize() {
		...
		mntmGestisciFabbisogno.addActionListener(new ApriGestioneFabbisognoActionListener());
		...
		menuBar.add(mntmGestisciFabbisogno);
